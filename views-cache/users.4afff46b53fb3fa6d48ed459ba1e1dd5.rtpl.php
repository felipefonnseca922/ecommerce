            ...
            <div class="box-body no-padding">
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?php echo htmlspecialchars( $value1["piduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                    <td><?php echo htmlspecialchars( $value1["pdesperson"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                    <td><?php echo htmlspecialchars( $value1["pdesemail"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
                    <td><?php echo htmlspecialchars( $value1["pdeslogin"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td/>
